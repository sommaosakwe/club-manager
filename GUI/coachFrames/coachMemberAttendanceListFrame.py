...
class coachMemberAttendanceListFrame(Frame):
    ...
    def addMember(self, username):
        ...
        self.parentFrame.switchFrame("coachMemberAttendanceList")
    ...
    def createMemberAttendanceEntry(self, parent, username, isInClub, isOverdue, eligibleForDiscount):
        entry = Frame(parent)
    ...
    def memberListBox(self, parent):
        ...
        members = memberStats.sortedMembersByAttendance()
        for m in range(len(members)):
            self.createMemberAttendanceEntry(scrollableFrame.scrollable_frame, members[m][0], members[m][1], 
    ...
    def __init__(self, parent):
        Frame.__init__(self, parent, name="coachMemberAttendanceList")
        ...
        memberAttendance = Button(nav, text="Member Attendance List")
